...
debug('================================');
debug('ユーザーブックマークページ userBookmarkPage.php');
debug('================================');
debugLogStart();
...
$dbIllustData = getIllustBookmarkList($headNum, $sort, $showNum, $postUserId);
//ユーザーデータを取得
...
<li>
  <a href="userPage.php<?php echo '?u_id=' .$postUserId ?>&sort=date">イラスト</a>
</li>
<li>
  <a href="userBookmarkPage.php<?php echo '?u_id=' .$postUserId ?>&sort=date" class="current">ブックマーク</a>
</li>
</ul>
</form>
</section>
...
<ul class="order_select">
<li>
  <a href="userBookmarkPage.php<?php echo '?u_id=' .$postUserId ?>&sort=date<?php if(!empty($searchWord)) echo ('&search-word=' .$searchWord); ?>" class="<?php echo getCurrentSort($sort); ?>">投稿順</a>
</li>
<li>
  <a href="userBookmarkPage.php<?php echo '?u_id=' .$postUserId ?>&sort=bookmark<?php if(!empty($searchWord)) echo ('&search-word=' .$searchWord); ?>" class="<?php if($sort === 2) echo 'current' ?>">人気順</a>
</li>
<!--
<li>
